        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricingTiers.map((tier, index) => (
              <div
                key={index}
                className={`relative p-8 rounded-2xl ${tier.popular
              ...
              >
                ...
                <h3
                  className={`text-2xl font-bold mb-2 ${tier.popular ? 'text-white' : 'text-gray-900'
                    }`}
                >
                  {tier.name}
                </h3>
                <p
                  className={`text-sm mb-6 ${tier.popular ? 'text-blue-100' : 'text-gray-600'
                    }`}
                >
                  {tier.description}
                </p>
                ...
                <ul className="space-y-3">
                  {tier.features.map((feature, fIndex) => (
                    <li key={fIndex} className="flex items-start gap-3">
                      <CheckCircle
                        className={`w-5 h-5 flex-shrink-0 ${tier.popular ? 'text-blue-200' : 'text-green-600'
                          }`}
                      />
                      <span
                        className={`text-sm ${tier.popular ? 'text-blue-50' : 'text-gray-700'
                          }`}
                      >
                        {feature}
                      </span>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-5 h-5 text-gray-600 transition-transform ${activeFaq === index ? 'rotate-180' : ''
                      }`}
                  />
                </button>
                {activeFaq === index && (
