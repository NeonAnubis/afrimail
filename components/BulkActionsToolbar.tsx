...
export const BulkActionsToolbar: React.FC<BulkActionsToolbarProps> = ({
  ...
  const handleBulkSuspend = async () => {
    ...
    setIsLoading(true);
    try {
      await ApiClient.post('/admin/bulk/suspend', { user_ids: selectedUserIds });
      onActionComplete();
      onClearSelection();
    } catch (error) {
  ...
  const handleBulkUnsuspend = async () => {
    ...
    setIsLoading(true);
    try {
      await ApiClient.post('/admin/bulk/unsuspend', { user_ids: selectedUserIds });
      onActionComplete();
      onClearSelection();
    } catch (error) {
  ...
  const handleBulkDelete = async () => {
    ...
    setIsLoading(true);
    try {
      await ApiClient.post('/admin/bulk/delete', { user_ids: selectedUserIds });
      onActionComplete();
      onClearSelection();
    } catch (error) {
  ...
  const handleBulkQuotaUpdate = async () => {
    ...
    setIsLoading(true);
    try {
      await ApiClient.post('/admin/bulk/quota', {
