...
export const AdminManagement: React.FC = () => {
  ...
  const [_roleFormData, setRoleFormData] = useState({
    name: '',
    description: '',
    permissions: {},
  });
  ...
  const handleCreateAdmin = async (e: React.FormEvent) => {
    ...
    try {
      const newAdmin = await ApiClient.post<AdminUser>('/admin/admins', formData);
  ...
  const handleToggleAdmin = async (admin: AdminUser) => {
    try {
      ...
      setToast({ message: error.message || 'Failed to toggle admin status', type: 'error' });
    }
  };
                    ...
                    <div className="flex items-center gap-4 flex-1">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {!admin.is_active && <Badge variant="error">Inactive</Badge>}
                          <Badge variant="default">{getRoleName(admin.role_id)}</Badge>
                        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="space-y-3 max-h-96 overflow-y-auto">
                  {Object.entries(selectedRole.permissions).map(([category, perms]: [string, any]) => (
