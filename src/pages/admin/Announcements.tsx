...
export const Announcements: React.FC = () => {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setToast({ message: error.message || 'Failed to create announcement', type: 'error' });
    }
  };
  ...
  const handlePublish = async (id: string) => {
    try {
      ...
      setToast({ message: error.message || 'Failed to publish announcement', type: 'error' });
    }
  };
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      setToast({ message: error.message || 'Failed to delete announcement', type: 'error' });
    }
  };
