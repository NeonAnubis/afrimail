...
export const ScheduledActions: React.FC = () => {
  ...
  const fetchActions = async () => {
    ...
    try {
      ...
      setToast({ message: error.message || 'Failed to fetch scheduled actions', type: 'error' });
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleCreateAction = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setToast({ message: error.message || 'Failed to create scheduled action', type: 'error' });
    }
  };
  ...
  const handleDeleteAction = async (action: ScheduledAction) => {
    ...
    try {
      ...
      setToast({ message: error.message || 'Failed to delete scheduled action', type: 'error' });
    }
  };
  ...
  const getStatusBadge = (status: string): 'default' | 'success' | 'danger' => {
    const variants = {
