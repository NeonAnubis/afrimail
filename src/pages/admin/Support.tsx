...
export const Support: React.FC = () => {
  ...
  const handleResolve = async (ticketId: string) => {
    try {
      ...
      setToast({ message: error.message || 'Failed to resolve ticket', type: 'error' });
    }
  };
  ...
  const handleReject = async (ticketId: string) => {
    try {
      ...
      setToast({ message: error.message || 'Failed to reject ticket', type: 'error' });
    }
  };
  ...
  const handleUnlock = async (email: string) => {
    try {
      ...
      setToast({ message: error.message || 'Failed to unlock account', type: 'error' });
    }
  };
